...
console.log("Is my Low Calorie food " + isLowCalorie(myFavFood));
...
function isSafeForNutAllergies(food) {
  if (food.ingredients.includes("sesame")){
    return false;
  }else{
    return true;
  }
...
console.log("Is my favorite food nut allergy safe? " + isSafeForNutAllergies(myFavFood))
